...
Route::middleware(['auth', 'verified', 'setting'])->group(function () {
    ...
    Route::middleware('plan.access')->group(function () {
        ...
        Route::middleware('permission:manage-employees')->group(function () {
            ...
            Route::get('hr/org-chart', [EmployeeController::class, 'orgChart'])->name('hr.org-chart.index');
        });
        ...
        Route::middleware('permission:manage-leave-applications')->group(function () {
            ...
            Route::put('hr/leave-applications/{leaveApplication}/status', [\App\Http\Controllers\LeaveApplicationController::class, 'updateStatus'])->name('hr.leave-applications.update-status');
        });
