...
export default function Departments() {
  ...
  const { auth, departments, branches, employees, allDepartments, filters: pageFilters = {}, globalSettings } = usePage<any>().props;
        ...
        formConfig={{
          fields: [
            ...
            },
            {
              ...
              type: 'select',
              searchable: true,
              options: allDepartments ? allDepartments.map((dept: any) => ({
