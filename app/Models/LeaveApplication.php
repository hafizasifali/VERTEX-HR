...
class LeaveApplication extends BaseModel
{
    ...
    protected $fillable = [
        ...
        'approved_at',
        'created_by',
        // Newly added: manager & HR approval workflow fields
        'manager_id',
        'manager_status',
        'manager_approved_at',
        'manager_comments',
    ...
    /**
     * Get the reporting manager for this leave.
     */
    ...
    /**
     * Get the HR person who gave final approval.
     */
    public function hrPerson()
    {
        return $this->belongsTo(User::class, 'hr_person_id');
    }
    ...
    /**
     * Get the final approver (legacy/compatibility).
     */
